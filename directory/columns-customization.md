...
Drag column headers left or right to reorder. Put identifying info (Name, Title) leftmost; group related fields together; put analysis fields after.
...
Save your column configuration as a named view (Views > Save Current View) to quickly reload it. Create separate views for Compensation Analysis, Contact Lists, SOC Review, etc.
