...
From the homepage, click **+** or **Create Scenario**. Also accessible from the top-right button in Main Org.
...
**New Org (blank)** — Empty canvas to build from scratch. Use for new department creation, greenfield design, or zero-based planning.

## Step 2: Name It

Use the pattern: `[Area] [Purpose] [Time Period]`

Good examples: "Engineering Q2 2026 Reorg", "Commercial NA Budget Cut 10%", "Product Team Q3 Growth - Option A"
