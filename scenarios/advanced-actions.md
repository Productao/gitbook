...
* [Scenario Refresh](advanced-actions/scenario-refresh.md) — Update an existing scenario with the latest Main Org data while preserving your changes
...
* [Partial Data Upload](advanced-actions/partial-data-upload-1.md) — Upload data for specific parts of a scenario
