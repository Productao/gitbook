---
description: Tracking scenario changes and workforce cost impact
...
The Scenario Changes & Impact panel (OpEx Panel) is the central hub for reviewing all changes made in a scenario and understanding their impact on workforce cost. It's also where you submit scenarios for approval.
...
**Switch between salary and custom formulas** to evaluate changes using your preferred financial metric.
...
Toggle to the **effective date view** to see all changes grouped by their effective date. This helps you understand the phased impact of your scenario changes over time.

### Submitting for Approval

The OpEx Panel is also where you submit scenarios for approval:
...
4. Provide a justification for your changes
5. Click **Submit**
