...
* [Scenario Approvals](scenarios/scenario-approvals.md)
...
* [⚙️ Advanced Scenario Actions](scenarios/advanced-actions.md)
  ...
  * [Scenario Refresh](scenarios/advanced-actions/scenario-refresh.md)
...
* [General Settings](admin-capabilities/general.md)
* [Data Upload & Management](data-import/overview.md)
  ...
  * [Formulas](data-import/formulas.md)
* [Rate Cards / Compensation Bands](settings/compensation-cards.md)
* [Auto Mapping](settings/automapping.md)
* [Fields and Attributes Management](settings/overview.md)
