...
**Span groupings (gear icon):** Customize ranges to match your needs. Recommended for manager analysis: exclude 0–0 (ICs), include 1–2, 3–5, 6–9, 10–15, 16–25, 26–40. Drag to reorder from smallest to largest.
...
**Filters:** Apply KLT area or department filter to analyze one org at a time — clearer patterns emerge with focused scope.

## Interpreting the Data

**High concentrations in 1–2 span columns:** Potential compression — leaders managing minimal teams. Some 1:1 relationships are legitimate (VP of Strategy under CEO), but many indicate structural inefficiency.
...
**Budget planning:** Configure chart > filter to one KLT area > identify high concentrations in 1–2 range > note layers of concern > navigate to org chart with Spotlight (Direct SOC = 1–2) to investigate specifics.
...
**Cross-department comparison:** Filter to Dept A, note pattern, screenshot; switch to Dept B, compare — which has more narrow spans? Which structure could inform the other?

## Interactive Features

**Show Table** — Click to see position-level breakdown behind each cell: exact lists, all attributes, exportable.

**Clickable cells** — Click a cell (in some versions) to drill in and filter to that span/layer combination.
