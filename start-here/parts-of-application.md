...
Your current organizational structure, synced from your HRIS or data file. The Main Org is **view-only** — to model changes, create a scenario.
...
Editable copies of your org where you can model changes without affecting live data. Add, move, edit, or close positions, then review the cost and headcount impact in the OpEx Panel.
...
Forward-looking headcount and cost projections over time. Forecast works in monthly, quarterly, or yearly views and shows how scenario changes phase in based on effective dates.
...
A searchable, sortable table view of all positions and people. Customize which columns are visible, apply filters, sort by any attribute, and export to CSV or Excel.
...
When you log in, you land on the homepage, which shows your recently accessed scenarios, a button to create new scenarios, and links to documentation and support.
